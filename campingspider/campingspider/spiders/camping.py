...
class CampingSpider(scrapy.Spider):
    ...
    def parse_campingplatz(self, response):
        ...
        feature_xpaths = {
            ...
            'baby pool': '//*[@id="features"]/div/div[1]/div[4]/div[10]/div/span/span',
            ...
            'lounge': '//*[@id="features"]/div/div[3]/div[5]/div[1]/div/span/span',

            'info corner': '//*[@id="features"]/div/div[3]/div[5]/div[3]/div/span/span',
